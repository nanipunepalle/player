...
describe('errors', () => {
  ...
  const oneInputWithErrorOnLoadBlockingFalseAndWarningNavigationTriggerFlow = makeFlow(
    {
      id: 'view-1',
      type: 'view',
      thing1: {
  ...
  const oneInputWithErrorOnLoadBlockingFalseAndWarningChangeTriggerFlow = makeFlow(
    {
      id: 'view-1',
      type: 'view',
      thing1: {
