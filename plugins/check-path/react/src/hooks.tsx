...
/** @deprecated - use useGetPath instead, it also has better support with an additional and optional query argument */
export const useGetPathInView = (asset: AssetOrID | undefined) =>
  useGetPath(asset);
